async function fetchConfig() {
    try {
        const response = await fetch('https://raw.githubusercontent.com/520CCC/LonganFortune/main/home.json', {
            headers: {
        ...
        // 获取配置参数
        const key = data.LonganFortune_key;
        const ent = data.LonganFortune_ent;
        const tz = data.LonganFortune_tz;
        const url = data.LonganFortune_ur;
